...
def encode(word):
    """
    Шифрует переданное слово с помощью шифра Цезаря со сдвигом 3.

    Аргументы:
        word (str): Входная строка для шифрования.
...
def decode(word):
    """
    Расшифровывает переданное слово, зашифрованное шифром Цезаря со сдвигом 3.

    Аргументы:
        word (str): Входная строка для расшифровки.
